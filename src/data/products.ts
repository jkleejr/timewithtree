...
<p class="text-xs text-muted-foreground mt-4 leading-relaxed whitespace-pre-line">※ R은 Radius를 뜻하며 근원직경 (줄기의 지면에 닿는 부분의 지름)을 표기하는 방식입니다.<br/>R3는 줄기 지름이 3cm, R4는 줄기 지름이 4cm, R5는 줄기지름이 5cm 입니다.</p>`;
