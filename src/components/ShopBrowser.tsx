      ...
      <AccordionItem value="shipping">
        ...
        <AccordionContent className="font-sans font-normal text-foreground">
          <div className="space-y-4 text-base md:text-lg leading-relaxed">
            <p>
              <span>나무는 에어포트(화분 재배)에 식재된 상태로 배송됩니다.</span><br />
                      ...
                      return (
                        <li
                          ...
                          className={`grid grid-cols-[48px_1fr] lg:flex lg:items-center gap-x-3 gap-y-3.5 px-4 py-4 sm:py-3 cursor-pointer transition-colors ${
                            isActive && activeVariant?.id === variant.id ? "bg-secondary/80" : "hover:bg-secondary/20"
                          }`}
                        ...
                        >
                          ...
                          <div className="flex-1 min-w-0 break-keep">
                            ...
                            {variant.description ? (
                              <p className="text-muted-foreground text-xs sm:text-sm mt-0.5 min-h-[3rem] sm:min-h-[5rem]">
                                {variant.description}
                              </p>
                            ) : (
                              <p className="text-primary text-xs sm:text-sm min-h-[3rem] sm:min-h-[5rem]">
                                예상출고시기:{" "}
