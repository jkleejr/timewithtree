                      ...
                      return (
                        ...
                        >
                          ...
                          <div className="flex-1 min-w-0 break-keep">
                            ...
                            {variant.description ? (
                              <p className="text-muted-foreground text-xs sm:text-sm mt-0.5 min-h-[3rem] sm:min-h-[3.75rem]">
                                {variant.description}
                              </p>
                            ) : (
                              <p className="text-primary text-xs sm:text-sm min-h-[3rem] sm:min-h-[3.75rem]">
                                예상출고시기:{" "}
