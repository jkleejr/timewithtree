...
const Index = () => {
  ...
  return (
    <SiteLayout>
      <Seo
        title="나무와 걷는 시간 - 잭큐몬티 자작나무 화분 재배"
        description="네덜란드에서 직수입한 잭큐몬티 자작나무. 에어포트(Air-Pot) 화분에서 건강하게 재배한 굵기 4~5cm의 프리미엄 묘목. 화분으로 재배하여 연중 식재 가능. 식재 후 활착률이 높아 고사 위험 현저히 낮음. 사계절, 마음에 안식을 주는 정원."
        path="/"
      />
      {/* Hero gallery */}
      <section className="relative">
        ...
        <div ref={heroWheelRef} className="relative w-full overflow-hidden bg-secondary aspect-[4/5] md:aspect-[16/8] touch-pan-y" {...heroSwipe}>
          ...
          {/* Intro overlay */}
          <div className="relative md:absolute md:inset-0 z-[5] max-w-7xl mx-auto px-6 md:px-10 py-8 md:py-16 flex flex-col gap-4 sm:gap-6 md:gap-8 pointer-events-none min-h-full">
        ...
        <div className="max-w-7xl mx-auto px-6 md:px-10">
          ...
          <div className="border-t border-border">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-px bg-border border border-border">
              ...
              <article className="bg-background p-5 md:p-7 flex flex-col gap-4 min-h-[170px] md:min-h-[200px]">
                <div className="flex items-center justify-between">
      ...
      <section id="info" className="scroll-mt-24 border-t border-border pt-10 md:pt-14 pb-4 md:pb-6">
        <div className="max-w-7xl mx-auto px-6 md:px-10">
          <div className="max-w-3xl mb-8 md:mb-10">
