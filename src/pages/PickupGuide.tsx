    ...
    <SiteLayout>
      <section className="max-w-4xl mx-auto px-6 md:px-10 py-16 md:py-24">
        ...
        <div className="space-y-10 text-base leading-relaxed text-foreground/90">
          <div>
            <h2 className="text-xl md:text-2xl font-semibold mb-4">네비 검색 안내</h2>
          ...
          <div>
            <h2 className="text-xl md:text-2xl font-semibold mb-4">2개 농장의 주소</h2>
          ...
          <div>
            <h2 className="text-xl md:text-2xl font-semibold mb-4">연락처</h2>
            <p className="text-muted-foreground">010-8925-6251</p>
          ...
          <div>
            <h2 className="text-xl md:text-2xl font-semibold mb-4">상담 가능 시간</h2>
            <p className="text-muted-foreground">
              오전 9시 ~ 오후 5시<br />
              설, 추석 외 연중 무휴 오픈합니다.
            </p>
          ...
          <div className="space-y-5 border-t border-border pt-8">
            <p className="text-muted-foreground">
              나무는 크기와 수량에 따라 차량배송 또는 직접 방문 수령이 가능합니다. 수령하실 나무의 품종, 수량, 규격을 미리 말씀해 주시면 더욱 빠르게 준비해 드릴 수 있습니다.
            </p>
            <p className="text-muted-foreground">
