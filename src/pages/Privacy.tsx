  ...
  return (
    <SiteLayout>
      <section className="max-w-4xl mx-auto px-6 md:px-10 py-16 md:py-24">
        ...
        <div className="space-y-8 text-base md:text-lg leading-relaxed text-foreground/90">
          ...
          <div className="space-y-3">
            ...
            <div className="space-y-2">
              ...
              <p>
                나무와 걷는 시간은 이용자 혹은 법정 대리인의 요청에 의해 해지 또는 삭제된 개인정보는 &ldquo;회사 가 수집하는 개인정보의 보유 및 이용기간&rdquo;에 명시된 바에 따라 처리하고 그 외의 용도로 열람 또는 이용할 수 없도록 처리하고 있습니다.
              </p>
            </div>
          </div>
