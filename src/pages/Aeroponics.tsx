    ...
    <SiteLayout>
      ...
      <section className="max-w-4xl mx-auto px-6 md:px-10 pb-20">
        <div className="border-t border-border pt-12 grid gap-12 font-sans">
          <article>
            <h2 className="font-display text-2xl md:text-3xl mb-3 font-sans">✔ 뿌리 회전 완전 방지</h2>
          ...
          <article>
            <h2 className="font-display text-2xl md:text-3xl mb-3 font-sans">✔ 잔뿌리 폭발적 증가</h2>
            <p className="text-muted-foreground leading-relaxed">
          ...
          <article>
            <h2 className="font-display text-2xl md:text-3xl mb-3 font-sans">✔ 과습 & 뿌리썩음 예방</h2>
            <p className="text-muted-foreground leading-relaxed">
          ...
          <article>
            <h2 className="font-display text-2xl md:text-3xl mb-3 font-sans">✔ 토양 산소 공급 최적화</h2>
            <p className="text-muted-foreground leading-relaxed">
