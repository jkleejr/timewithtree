    ...
    <SiteLayout>
      ...
      <section className="max-w-4xl mx-auto px-6 md:px-10 pb-20">
        <div className="border-t border-border pt-12 grid gap-12 font-sans">
          <article>
            <h2 className="font-display text-2xl md:text-3xl mb-3 font-sans">연중 식재 가능</h2>
          ...
          <article>
            <h2 className="font-display text-2xl md:text-3xl mb-3 font-sans">건강한 뿌리, 높은 활착률</h2>
            <p className="text-muted-foreground leading-relaxed">
          ...
          <article>
            <h2 className="font-display text-2xl md:text-3xl mb-3 font-sans">깨끗하고 안정적인 운반</h2>
            <p className="text-muted-foreground leading-relaxed">
          ...
          <article>
            <h2 className="font-display text-2xl md:text-3xl mb-3 font-sans">균일한 품질</h2>
            <p className="text-muted-foreground leading-relaxed">
